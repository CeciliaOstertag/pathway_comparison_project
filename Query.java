...
/**
 * This class is used to query NCBI Protein DB for enzyme sequences in fasta format
 * 
...
public class Query {
	...
	/**
	 * Automated query to NCBI Protein database. Uses a Protein GI id to search the corresponding sequence, and download the file in fasta format
	 * 
